(function () {
  ...
  async function initEmailForm() {
    ...
    let formRedirectUrl = "/demande-tarifs/merci";

    function setRedirectByProfile(profileValue) {
      let redirectUrl = "/demande-tarifs/merci";
      ...
      if (
        ...
        redirectUrl = "/demande-tarifs/merci-beaucoup";
      }
    ...
    $(form).on("submit", function () {
      ...
      if (targetGeo === "FALSE" || excludeReason) {
        formRedirectUrl = "/demande-tarifs/nsq";
